...
<div class="span-18">
  ...
  <div id="boxNovedades">
    <ul class="novedades">
      ...
      <li class="promos"><span class="shows"><img src="images/box_promos_convertiteas.jpg" width="130" height="130" class="novedades-imagen" /></span><?php 
echo link_to('Promos', 'pages/index?id=5') ?></li>
