    ...
    <div class="span-9 prepend-10 last" id="global">
    	<ul class="above-menu">
    		...
    		<li id="reservas"><a href="javascript:;">Reservas Hotel</a>
    			<ul>
    				<li><iframe src="http://www.idiso.com/csl/reservations/jsp/C_Search_Dates.jsp?&codigoHotel=1652&lang=es&idPartner=CASINOMAGIC&idPrm=MBCASINOMG&idONg=P25&idNom=webpropia" width="460" height="300" frameborder="0" allowtransparency="true" id="iframeBEIdiso"></iframe></li>
    			</ul>
    		</li>
    	</ul>	
    </div>
