...
CREATE TABLE mdgalledy_album_gallery (id BIGINT AUTO_INCREMENT, gallery_id BIGINT, album_id BIGINT, INDEX gallery_id_idx (gallery_id), INDEX album_id_idx (album_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE event_gallery ADD CONSTRAINT event_gallery_gallery_id_mdgalledy_gallery_id FOREIGN KEY (gallery_id) REFERENCES mdgalledy_gallery(id);
ALTER TABLE event_gallery ADD CONSTRAINT event_gallery_event_id_events_id FOREIGN KEY (event_id) REFERENCES events(id);
...
ALTER TABLE mdgalledy_album_gallery ADD CONSTRAINT mdgalledy_album_gallery_gallery_id_mdgalledy_gallery_id FOREIGN KEY (gallery_id) REFERENCES mdgalledy_gallery(id);
ALTER TABLE mdgalledy_album_gallery ADD CONSTRAINT mdgalledy_album_gallery_album_id_mdgalledy_album_id FOREIGN KEY (album_id) REFERENCES mdgalledy_album(id);
...
ALTER TABLE mdgalledy_gallery_photo ADD CONSTRAINT mdgalledy_gallery_photo_photo_id_mdgalledy_photo_id FOREIGN KEY (photo_id) REFERENCES mdgalledy_photo(id);
ALTER TABLE mdgalledy_gallery_photo ADD CONSTRAINT mdgalledy_gallery_photo_gallery_id_mdgalledy_gallery_id FOREIGN KEY (gallery_id) REFERENCES mdgalledy_gallery(id);
